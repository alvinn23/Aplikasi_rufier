...
class FinalWin(QWidget):
    ...
    def results(self):
        self.index = (4 * (self.experiment.p1 + self.experiment.p2 + self.experiment.p3) - 200) / 10
        if self.experiment.age >= 15:
            if self.index >= 15:
                return text_res1
        ...
        elif self.experiment.age >= 13 and self.experiment.age < 15: 
            # TO DO 
            if self.index >= 15:
                return text_res1
            elif self.index >= 11 and self.index < 15:
